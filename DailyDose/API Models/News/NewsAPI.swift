...
func getNewsArticlesFromApi(trending: Bool, source: String, query: String) -> [NewsStruct]? {
    var foundArticles = [NewsStruct]()
    ...
    do {
        ...
        if let arrayOfFoundNews = jsonObject["articles"] as? [Any] {
                ...
                for source in arrayOfFoundNews {
                    ...
                    foundArticles.append(newNewsFound)
                }   // End of for loop
            } else { return nil }
        } else { return nil }
    } catch { return nil }
...
//        }
    ...
    apiUrlString = apiUrlString + "apiKey=" + newsAPIKey
    print(apiUrlString)
    return apiUrlString
}
